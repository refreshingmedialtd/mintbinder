...
export const betaQaChecks = [
  ...
  {
    id: "set-goal-read-auth-required",
    gate: "Set Builder",
    method: "GET",
    path: "/api/set-goal",
    expectedStatuses: [401],
  ...
  {
    id: "set-goal-update-auth-required",
    gate: "Set Builder",
    method: "PUT",
    path: "/api/set-goal",
    body: { cardSetId: "00000000-0000-4000-8000-000000000001" },
    expectedStatuses: [401],
    allowedJsonErrors: AUTH_REQUIRED,
  },
  {
    id: "set-goal-wishlist-auth-required",
    gate: "Set Builder",
    method: "POST",
    path: "/api/set-goal/wishlist",
    body: {},
    expectedStatuses: [401],
    allowedJsonErrors: AUTH_REQUIRED,
  },
